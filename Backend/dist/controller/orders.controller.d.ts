...
export declare function getOrdersController(req: Request, res: Response): Promise<void>;
...
export declare function createAdminOrderController(req: Request, res: Response): Promise<void>;
