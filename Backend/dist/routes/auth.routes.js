...
authRoutes.post("/forget-password", rateLimiter, verifyAccessTokenAndGetUser, userForgetPassword);
authRoutes.post("/reset-password", rateLimiter, verifyAccessTokenAndGetUser, userResetPassword);
authRoutes.patch("/change-password", rateLimiter, verifyAccessTokenAndGetUser, userChangePassword);
